/*
 jQuery paging plugin v1.1.1 21/04/2014
...
{e:"block",h:0,c:0},h=0):(e.d[e.d.length]={e:n[c],h:g,c:r===f[c]?f[c]=1:++f[c]},"q"===c?++e.j:"p"===c&&++e.i);return e}(b.a.format);return b},setNumber:function(a){b.l=r===a||0>a?-1:a;return b},setPage:function(a){function u(a,b,c){c=""+a.onFormat.call(b,c);p=b.value?p+c.replace(/<a/i,'<a data-page="'+b.value+'"'):p+c}if(r===a){if(a=b.a.page,null===a)return b}else if(b.a.page==a)return b;b.a.page=a|=0;if(null!==b.a.onLock)return b.a.onLock(a),b;var m=b.l,g=b.a,h,e,c,p,v=1,f=b.format,d,k,l,q,x=f.d.length,
